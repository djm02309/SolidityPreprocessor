...
public interface SolidityListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SolidityParser#nonFallbackStatement}.
	 * @param ctx the parse tree
	 */
	void enterNonFallbackStatement(SolidityParser.NonFallbackStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#nonFallbackStatement}.
	 * @param ctx the parse tree
	 */
	void exitNonFallbackStatement(SolidityParser.NonFallbackStatementContext ctx);
	/**
